/* eslint-disable */
// Generated by Wrangler by running `wrangler types worker-configuration.d.ts --config wrangler.deploy.jsonc` (hash: bb7fe33e06e70a4252c1f364d427dde6)
// Runtime types generated with workerd@1.20260515.1 2026-09-12 nodejs_compat
interface __BaseEnv_Env {
	DB: D1Database;
	AUTH_RATE_LIMITER: RateLimit;
	API_WRITE_RATE_LIMITER: RateLimit;
	STUDENT_REQUEST_RATE_LIMITER: RateLimit;
	SUPABASE_URL: string;
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SUPABASE_URL" | "SUPABASE_PUBLISHABLE_KEY" | "SUPABASE_SECRET_KEY" | "INITIAL_OWNER_EMAIL" | "INITIAL_OWNER_NAME">> {}
}
